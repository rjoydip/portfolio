...
pubDate: 2025-01-07T12:00:00.000+00:00
---
...
<figure class="text-center">
  <img src="/images/epoch-semver-progressive-1.png" alt="Progressive as Stairs" class="border base rounded-xl">
  <figcaption>Progressive as Stairs - a screenshot of my talk <a class="italic font-serif" href="/talks#the-progressive-path" target="_blank">The Progressive Path</a></figcaption>
</figure>
...
<figure class="text-center">
  <img src="/images/epoch-semver-progressive-2.png" alt="Progressive on Breaking Changes" class="border base rounded-xl">
  <figcaption>Progressive on Breaking Changes - a screenshot of my talk <a class="italic font-serif" href="/talks#the-progressive-path" target="_blank">The Progressive Path</a></figcaption>
</figure>
...
<div class="py4">
  <code class="text-xl text-gray"><span class="line-through">ZERO</span>.<span class="font-bold text-amber">MAJOR</span>.{<span class="font-bold text-lime">MINOR</span> + <span class="font-bold text-blue">PATCH</span>}</code>
</div>
...
<div class="py4">
  <code class="text-xl text-gray">{<span class="font-bold text-violet">EPOCH</span> * 1000 + <span font-bold text-amber>MAJOR</span>}.<span font-bold text-lime>MINOR</span>.<span font-bold text-blue>PATCH</span></code>
</div>
